...
{
    public class cBwsKQHT_MonHoc_CT_KhoiKienThuc : cBwsBase
    {
        ...
        public cBwsKQHT_MonHoc_CT_KhoiKienThuc()
        {
        ...
        public DataTable Get(KQHT_MonHoc_CT_KhoiKienThucInfo pKQHT_MonHoc_CT_KhoiKienThucInfo)
        {
            ...
            {
                return ConvertList.ToDataTable<sp_KQHT_MonHoc_CT_KhoiKienThuc_GetResult>(client.cDKQHT_MonHoc_CT_KhoiKienThuc_Get(GlobalVar.MaXacThuc, pKQHT_MonHoc_CT_KhoiKienThucInfo));
            }
        }
        ...
        public int Add(KQHT_MonHoc_CT_KhoiKienThucInfo pKQHT_MonHoc_CT_KhoiKienThucInfo)
        {
            ...
            ID = client.cDKQHT_MonHoc_CT_KhoiKienThuc_Add(GlobalVar.MaXacThuc, pKQHT_MonHoc_CT_KhoiKienThucInfo);
            client.Close();
        ...
        {
            var client = new UnimOsServiceClient();
            client.cDKQHT_MonHoc_CT_KhoiKienThuc_Delete(GlobalVar.MaXacThuc, pKQHT_MonHoc_CT_KhoiKienThucInfo);
            client.Close();
            mErrorMessage = oDKQHT_MonHoc_CT_KhoiKienThuc.ErrorMessages;
            mErrorNumber = oDKQHT_MonHoc_CT_KhoiKienThuc.ErrorNumber;
        }
        ...
        public DataTable GetDanhSachMon(int IDKQHT_CT_KhoiKienThuc)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_KQHT_MonHoc_CT_KhoiKienThuc_GetDanhSachResult>(client.cDKQHT_MonHoc_CT_KhoiKienThuc_GetDanhSach(GlobalVar.MaXacThuc, IDKQHT_CT_KhoiKienThuc));
            }
        }
    }
}
