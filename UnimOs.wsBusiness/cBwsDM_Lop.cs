...
{
    public class cBwsDM_Lop : cBwsBase
    {
        ...
        {
            var client = new UnimOsServiceClient();
            DataTable dt = ConvertList.ToDataTable<sp_DM_Lop_GetTreeByIDGiaoVienResult>(client.cDDM_Lop_GetTreeByIDGiaoVien(GlobalVar.MaXacThuc, NamHoc, IDNS_GiaoVien, IDDM_NamHoc, HocKy));
            client.Close();
            return CreateTree(dt);
        }
        ...
        {
            var client = new UnimOsServiceClient();
            DataTable dt = ConvertList.ToDataTable<sp_DM_Lop_GetTree_ThiSinhTuDoResult>(client.cDDM_Lop_GetTree_ThiSinhTuDo(GlobalVar.MaXacThuc, NamHoc));
            client.Close();
            return CreateTree(dt);
        }
        ...
        public DataTable GetDanhSachLop_ThiSinhTuDo(string NamHoc)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_DM_Lop_GetTree_ThiSinhTuDoResult>(client.cDDM_Lop_GetTree_ThiSinhTuDo(GlobalVar.MaXacThuc, NamHoc));
            }
        }
        ...
        public DataTable GetTree(string NamHoc)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_DM_Lop_GetTreeResult>(client.cDDM_Lop_GetTree(GlobalVar.MaXacThuc, NamHoc));
                //return client.cDDM_Lop_GetTree(GlobalVar.MaXacThuc, NamHoc);
            }
        }
        ...
        public DataTable GetChon(int IDDM_TrinhDo, string NamHoc)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_DM_Lop_GetChonResult>(client.cDDM_Lop_GetChon(GlobalVar.MaXacThuc, IDDM_TrinhDo, NamHoc));
            }
        }
        ...
        public DataTable GetPhanBoPhongHoc(int IDNamHoc, string NamHoc, int HocKy, int CaHoc, int TuTuan, int DenTuan)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<DM_LopInfo>(client.cDDM_Lop_GetPhanBoPhongHoc(GlobalVar.MaXacThuc, IDNamHoc, NamHoc, HocKy, CaHoc, TuTuan, DenTuan));
            }
        }
        ...
        public DataTable GetChuongTrinhDaoTao(int DM_LopID)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_DM_Lop_GetChuongTrinhDaoTaoResult>(client.cDDM_Lop_GetChuongTrinhDaoTao(GlobalVar.MaXacThuc, DM_LopID));
            }
        }
        public DataTable GetTongDiemThanhPhan(int IDXL_MonHocTrongKy)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_KQHT_DiemThangPhan_GetTong_byIDXL_MonHocTrongKyResult>(client.cDDM_Lop_GetGetTongDiemThanhPhan(GlobalVar.MaXacThuc, IDXL_MonHocTrongKy));
            }
        }
        public DataTable GetByKhoa(int IDDM_Khoa, string @NamHoc)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_DM_Lop_GetByKhoaResult>(client.cDDM_Lop_GetByKhoa(GlobalVar.MaXacThuc, IDDM_Khoa, @NamHoc));
            }
        }
        ...
        public DataTable Get_TKB(long IDXL_Tuan)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_DM_Lop_Get_TKBResult>(client.cDDM_Lop_Get_TKB(GlobalVar.MaXacThuc, IDXL_Tuan));
            }
        }
        ...
        //    int ID = 0;
        //    var client = new UnimOsServiceClient();
        //    ID = client.cDDM_Lop_Add(GlobalVar.MaXacThuc, pDM_LopInfo);
        //    client.Close();
        ...
        //{
        //    var client = new UnimOsServiceClient();
        //    client.cDDM_Lop_Update(GlobalVar.MaXacThuc, pDM_LopInfo);
        //    client.Close();
        //    mErrorMessage = oDDM_Lop.ErrorMessages;
        //    mErrorNumber = oDDM_Lop.ErrorNumber;
        //}
        ...
        //{
        //    var client = new UnimOsServiceClient();
        //    client.cDDM_Lop_Delete(GlobalVar.MaXacThuc, pDM_LopInfo);
        //    client.Close();
        //    mErrorMessage = oDDM_Lop.ErrorMessages;
        //    mErrorNumber = oDDM_Lop.ErrorNumber;
        //}
