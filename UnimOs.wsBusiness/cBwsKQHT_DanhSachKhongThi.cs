...
namespace TruongViet.UnimOs.wsBusiness
{
    public class cBwsKQHT_DanhSachKhongThi : cBwsBase
    {
        ...
        //    {
        //        return ConvertList.ToDataTable<KQHT_DanhSachKhongThiInfo>(client.cDKQHT_DanhSachKhongThi_Get(GlobalVar.MaXacThuc, pKQHT_DanhSachKhongThiInfo));
        //    }
        //}
        ...
        public DataTable GetIn_SinhVien(int IDDM_Lop, int IDDM_MonHoc, int IDDM_NamHoc, int HocKy, int LanThi)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_KQHT_DanhSachKhongThi_GetIn_SinhVienResult>(client.cDKQHT_DanhSachKhongThi_GetIn_SinhVien(GlobalVar.MaXacThuc, IDDM_Lop, IDDM_MonHoc, IDDM_NamHoc, HocKy, LanThi));
            }
        }
        ...
        public DataTable GetNotIn_SinhVien(int IDDM_Lop, int IDDM_MonHoc, int IDDM_NamHoc, int HocKy, int LanThi)
        {
            using (var client = new UnimOsServiceClient())
            {
                return ConvertList.ToDataTable<sp_KQHT_DanhSachKhongThi_GetNotIn_SinhVienResult>(client.cDKQHT_DanhSachKhongThi_GetNotIn_SinhVien(GlobalVar.MaXacThuc, IDDM_Lop, IDDM_MonHoc, IDDM_NamHoc, HocKy, LanThi));
            }
        }
