...
namespace UnimOs.UI
{
    public partial class ucTreeLop : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void trlLop_BeforeCheckNode(object sender, DevExpress.XtraTreeList.CheckNodeEventArgs e)
        {
            e.State = (e.PrevState == CheckState.Checked ? CheckState.Unchecked : CheckState.Checked);
        }

        private void trlLop_AfterCheckNode(object sender, DevExpress.XtraTreeList.NodeEventArgs e)
        {
            (new frmBase()).SetCheckedChildNodes(e.Node, e.Node.CheckState);
            (new frmBase()).SetCheckedParentNodes(e.Node, e.Node.CheckState);
        }
    }
}
