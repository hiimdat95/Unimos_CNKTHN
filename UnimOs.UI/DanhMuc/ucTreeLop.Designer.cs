namespace UnimOs.UI
{
    partial class ucTreeLop
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.trlLop.BeforeCheckNode += new DevExpress.XtraTreeList.CheckNodeEventHandler(this.trlLop_BeforeCheckNode);
            this.trlLop.AfterExpand += new DevExpress.XtraTreeList.NodeEventHandler(this.trlLop_AfterExpand);
            this.trlLop.AfterCheckNode += new DevExpress.XtraTreeList.NodeEventHandler(this.trlLop_AfterCheckNode);
            // 
            // treeListColumn1
            // 
