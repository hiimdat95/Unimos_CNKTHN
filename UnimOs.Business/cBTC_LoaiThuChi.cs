...
namespace TruongViet.UnimOs.Business
{
    public class cBTC_LoaiThuChi : cBBase
    {
        ...
        {
            return oDTC_LoaiThuChi.Get(pTC_LoaiThuChiInfo);
        }

        public DataTable GetBy_IDNamHoc_HocKy(int IDNamHoc, int HocKy, bool HasParent)
        {
            return oDTC_LoaiThuChi.GetBy_IDNamHoc_HocKy(IDNamHoc, HocKy, HasParent);
        }
        ...
        {
			int ID = 0;
            ID = oDTC_LoaiThuChi.Add(pTC_LoaiThuChiInfo);
        ...
        {
            oDTC_LoaiThuChi.Update(pTC_LoaiThuChiInfo);
            mErrorMessage = oDTC_LoaiThuChi.ErrorMessages;
            mErrorNumber = oDTC_LoaiThuChi.ErrorNumber;
        }
        ...
        {
            oDTC_LoaiThuChi.Delete(pTC_LoaiThuChiInfo);
            mErrorMessage = oDTC_LoaiThuChi.ErrorMessages;
            mErrorNumber = oDTC_LoaiThuChi.ErrorNumber;
        }
