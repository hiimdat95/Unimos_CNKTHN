...
{
    public class cBKQHT_DiemThanhPhan : cBBase
    {
        ...
        {
            return oDKQHT_DiemThanhPhan.GetDanhSach(IDDM_Lop, IDDM_MonHoc, XL_MonHocTrongKyID, IDDM_NamHoc, HocKy, LanThi, KQHT_ChoNhapLaiDiemID);
        }

        public DataTable ChoNhapLaiDiem_GetDanhSach(int IDKQHT_ChoNhapLaiDiem)
        {
            return oDKQHT_DiemThanhPhan.ChoNhapLaiDiem_GetDanhSach(IDKQHT_ChoNhapLaiDiem);
        }
        ...
        {
            return oDKQHT_DiemThanhPhan.KiemTraDiem(IDSV_SinhVien, IDDM_Lop, IDDM_MonHoc, IDDM_NamHoc, HocKy);
        }
