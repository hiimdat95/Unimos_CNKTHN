...
{
    public class cBHT_DuLieuNhap : cBBase
    {
        ...
        {
            DataTable dt = new cBKQHT_ThanhPhanDiem().GetNhapDuLieu();
        ...
        {
            DataTable dt = new cBXL_MonHocTrongKy().GetNhapDuLieuByHocKyNamHoc(IDDM_Lop, IDDM_NamHoc, HocKy);
            DataRow dr = dt.NewRow();
            dr["ID"] = "MaSinhVien";
            dr["TenTruongDuLieu"] = "Mã sinh viên";
            dr["KieuDuLieu"] = "System.String";
        ...
        {
            cBSV_SinhVienNhapTruong cBSV_SinhVienNhapTruong = new cBSV_SinhVienNhapTruong();
            ...
            for (int i = 0; i < dtDuLieuChuyenDuoc.Rows.Count; i++)
            {
                ...
                try
                {
                    cBSV_SinhVienNhapTruong.ToInfo(ref pSV_SinhVienNhapTruongInfo, dtDuLieuChuyenDuoc.Rows[i], dtDuLieuChuyenDuoc);
                    cBSV_SinhVienNhapTruong.Add(pSV_SinhVienNhapTruongInfo);
                }
                catch
                {
        ...
        { 
            ...
            cBDM_KHOI_LOP oBDM_Khoi_Lop = new cBDM_KHOI_LOP();
        ...
        */
        ...
        public void ChuyenDanhSachMonHoc(ref DataTable dtDuLieuChuyenDuoc, ref DataTable dtDuLieuKhongChuyenDuoc, DataTable dtDuLieuNguon, Hashtable htb)
        {
            ...
            if (MaMonHoc != "")
            {
                ...
                string MaMonHocDaTonTai = oDDM_MonHoc.CheckExistByMaMonHoc(MaMonHoc, CheckTrung == "MaMonHoc" ? true : false);
                if (MaMonHocDaTonTai != "")
                {
        ...
        {
            cBKQHT_DiemThanhPhan oBKQHT_DiemThanhPhan = new cBKQHT_DiemThanhPhan();
        ...
        {
            cBKQHT_DiemTongKetMon oBKQHT_DiemTongKetMon = new cBKQHT_DiemTongKetMon();
        ...
        public void ChuyenDanhSachTinhHuyenXa(ref DataTable dtDuLieuChuyenDuoc, ref DataTable dtDuLieuKhongChuyenDuoc, DataTable dtDuLieuNguon, Hashtable htb)
        {
            ...
            if (Ma != "")
            {
                cBDM_TinhHuyenXa oBDM_TinhHuyenXa = new cBDM_TinhHuyenXa();
