...
{
    public class cBGG_HeSoLopDongTheoKhoa : cBBase
    {
        private cDGG_HeSoLopDongTheoKhoa oDGG_HeSoLopDongTheoKhoa;

        public cBGG_HeSoLopDongTheoKhoa()        
        {
        ...
        {
            return oDGG_HeSoLopDongTheoKhoa.Get(pGG_HeSoLopDongTheoKhoaInfo);
        }

        public DataTable GetAll(int GG_HeSoLopDongTheoKhoaID)
        {
            return oDGG_HeSoLopDongTheoKhoa.GetAll(GG_HeSoLopDongTheoKhoaID);
        }

        public int Add(GG_HeSoLopDongTheoKhoaInfo pGG_HeSoLopDongTheoKhoaInfo)
        {
			int ID = 0;
            ID = oDGG_HeSoLopDongTheoKhoa.Add(pGG_HeSoLopDongTheoKhoaInfo);
