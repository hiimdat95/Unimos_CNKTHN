...
namespace TruongViet.UnimOs.Business
{
    public class cBDM_PhongHoc : cBBase
    {
        ...
        {
            return oDDM_PhongHoc.Get(pDM_PhongHocInfo);
        }
        ...
        {
            return oDDM_PhongHoc.GetByIDToaNha(IDDM_ToaNha);
        }
        ...
        {
            return oDDM_PhongHoc.GetKeHoachThucHanh(IDDM_NamHoc, NamHoc);
        }

        public int Add(DM_PhongHocInfo pDM_PhongHocInfo)
        {
			int ID = 0;
            ID = oDDM_PhongHoc.Add(pDM_PhongHocInfo);
        ...
        {
            oDDM_PhongHoc.Update(pDM_PhongHocInfo);
            mErrorMessage = oDDM_PhongHoc.ErrorMessages;
            mErrorNumber = oDDM_PhongHoc.ErrorNumber;
        }
        ...
        {
            oDDM_PhongHoc.Delete(pDM_PhongHocInfo);
            mErrorMessage = oDDM_PhongHoc.ErrorMessages;
            mErrorNumber = oDDM_PhongHoc.ErrorNumber;
        }
