...
namespace TruongViet.UnimOs.Business
{
    public class cBKQHT_DaChuyenDiem : cBBase
    {
        ...
        {
            return oDKQHT_DaChuyenDiem.Get(pKQHT_DaChuyenDiemInfo);
        }

        public DataTable GetByIDMonHocTrongKy(int IDXL_MonHocTrongKy)
        {
            return oDKQHT_DaChuyenDiem.GetByIDMonHocTrongKy(IDXL_MonHocTrongKy);
        }

        public DataTable GetLichSuSuaDiem(int IDXL_MonHocTrongKy)
        {
            return oDKQHT_DaChuyenDiem.GetLichSuSuaDiem(IDXL_MonHocTrongKy);
        }

        public int Add(KQHT_DaChuyenDiemInfo pKQHT_DaChuyenDiemInfo)
        {
			int ID = 0;
            ID = oDKQHT_DaChuyenDiem.Add(pKQHT_DaChuyenDiemInfo);
        ...
        {
            int ID = 0;
            ID = oDKQHT_DaChuyenDiem.AddChuyen(pKQHT_DaChuyenDiemInfo);
            mErrorMessage = oDKQHT_DaChuyenDiem.ErrorMessages;
            mErrorNumber = oDKQHT_DaChuyenDiem.ErrorNumber;
            return ID;
        }
