...
namespace TruongViet.UnimOs.Business
{
    public class clsTKB : cBBase
    {
        ...
        private cBXL_SuKienTKB oBSuKienTKB;
        private XL_SuKienTKBInfo pSuKienTKBInfo;
        private cBXL_KeHoachChiTiet oBKeHoachChiTiet;
        ...
        private void DocThamSoXepLich()
        {
            ...
            dtThamSo = new cBHT_ThamSoHeThong().Get(pThamSoHeThongInfo);
