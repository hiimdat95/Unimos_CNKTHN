...
namespace TruongViet.UnimOs.Business
{
    ...
    public class MathParser : StandardLib
    {
        ...
        private class Sort : TruongViet.UnimOs.Business.MathParser.QuickSort
        {
            // Fields
            private object[] a;
    ...
    internal class NParamNode : Node
    {
        ...
        public override void Optimize()
        {
            for (int i = 0; i < this.nodes.Length; i++)
            {
                this.nodes[i] = TruongViet.UnimOs.Business.MathParser.OptimizeNode(this.nodes[i]);
            }
        }
    }
    ...
    internal class Variable
    {
        ...
        private TruongViet.UnimOs.Business.MathParser m_Parser;
        ...
        public Variable(TruongViet.UnimOs.Business.MathParser parser, string aName, IConvertible newVal, VariableDelegate valueProvider)
        {
    ...
    public delegate IConvertible VariableDelegate(TruongViet.UnimOs.Business.MathParser parser, string varName);
